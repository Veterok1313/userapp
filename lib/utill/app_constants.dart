...
class AppConstants {
  static const String APP_NAME = 'xsph';

  static const String BASE_URL = 'http://a0616849.xsph.ru/';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: '', languageName: 'Russian', countryCode: 'RU', languageCode: 'ru'),
  ];
}
